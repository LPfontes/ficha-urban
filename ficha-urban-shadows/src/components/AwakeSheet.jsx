  ...
  return (
    <div className="sheet-container active">
      ...
      <div className="sheet-page">
        ...
        {/* Cabeçalho */}
        <AbsoluteInput top={225} left={80} width={420} height={50} placeholder="Nome" />
        <AbsoluteInput top={225} left={515} width={100} height={50} placeholder="Pronomes" />
      ...
      <div className="sheet-page">
        ...
        {renderCheckboxes(365, 170, 6, 0, 24, 14, 14, "check-relacionamento-morto")}

        {/* Equipamentos Dinâmicos */}
        <div style={{ position: 'absolute', top: 730, left: 365, width: 545, display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <button 
          ...
          style={{color: 'white', position: 'absolute', top: 695, left: 705, cursor: 'pointer' }}
        >
        ...
        {renderCheckboxes(363, 1381, 2, 0, 84, 14, 14, "check-mov-corrupcao")}
        {renderCheckboxes(794, 1381, 2, 0, 84, 14, 14, "check-mov-corrupcao")}
      </div>
    </div>
  );
};

export default AwakeSheet;
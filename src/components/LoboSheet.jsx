...
const FichaLobo = () => {
  const page1Extras = (
    <>
      ...
      <AbsoluteInput top={986} left={76} width={17} height={17} type="checkbox" className="check-move" />
      <AbsoluteInput top={901} left={76} width={17} height={17} type="checkbox" className="check-move" />
      <AbsoluteInput top={1119} left={76} width={17} height={17} type="checkbox" className="check-move" />
